...
public class FlappyPig extends Application
    ...
    public static Font appFont = Font.loadFont( FlappyPig.class.getResource( "./fonts/04b_19.ttf" )
                                                               .toExternalForm(),
                                                42 ) ;
    ...
    public static Map<String, GameObject> gameObjects =
                                    new LinkedHashMap<String, GameObject>() ;
    private Pig pig ;
    ...
    private void inputHandler( double posX,
                               double posY )
        {
        if ( !gameEnded )
            {
    ...
    private void initRender()
        ...
        pig = new Pig( width, height, ctx ) ;

        gameObjects.put( "pig", pig ) ;
